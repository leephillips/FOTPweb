...
urlpatterns = patterns('',
     ...
     (r'^scholarship/$', 'ap.apdirposts.views.scholarship'),
     (r'^about/$', 'ap.apdirposts.views.about'),
     (r'^projects/$', 'ap.apdirposts.views.projects'),
     (r'^corporation/$', 'ap.apdirposts.views.corporation'),
     (r'^history/$', 'ap.apdirposts.views.history'),
     (r'^visit/$', 'ap.apdirposts.views.visit'),
     ...
     (r'^x7298/$', 'ap.apdirposts.views.x7298'),
     (r'^x7298inside/(.*)/$', 'ap.apdirposts.views.x7298inside'),
     (r'^x7297inside/$', 'ap.apdirposts.views.x7297inside'),
     (r'^preview/$', 'ap.apdirposts.views.preview_front'),
     (r'^configure_slideshow/$', 'ap.apdirposts.views.configure_slideshow'),
     (r'^publishweekend/$', 'ap.apdirposts.views.publishweekend'),
