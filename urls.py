...
urlpatterns = patterns('',
     ...
     (r'^givingtuesday/$', 'ap.apdirposts.views.givingtuesday'),
     (r'^donation_submit/$', 'ap.apdirposts.views.donation_submit'),
     (r'^tuesday_submit/$', 'ap.apdirposts.views.tuesday_submit'),
     (r'^donation_topaypal/$', 'ap.apdirposts.views.donation_topaypal'),
     (r'^tuesday_topaypal/$', 'ap.apdirposts.views.tuesday_topaypal'),
