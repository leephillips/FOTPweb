...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('apdirposts_director', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)

        # Adding field 'Director.phone'
        db.add_column('apdirposts_director', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Adding field 'Director.notes'
        db.add_column('apdirposts_director', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Director.email'
        db.delete_column('apdirposts_director', 'email')

        # Deleting field 'Director.phone'
        db.delete_column('apdirposts_director', 'phone')

        # Deleting field 'Director.notes'
        db.delete_column('apdirposts_director', 'notes')
